...
public class Calc {
    ...
    private void writeHistoryInFile() throws IOException {
        try (FileWriter writer = new FileWriter("/Users/Eugeniy/PycharmProjects/Izvekov-E.A.-Java/src/fifthHomeWork/calculator/History", true)) {
            String originalExpression = userFunction; String textResult = String.valueOf(result);
            writer.write("\n");
            writer.write("Исходное выражение " + originalExpression + " ");
            writer.write("ответ " + textResult);
        }
    }
}
